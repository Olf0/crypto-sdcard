...
* Support for Cryptsetup LUKS and Cryptsetup "plain".
  ...
  * Since *crypto-sdcard 1.3.4*, the [parsing of "key"-files for "plain" mode was enhanced](https://github.com/Olf0/crypto-sdcard/commit/ba3ccce0c3573747fadd7b30e576159b15277513) (as an experimental feature).<br />
    ...
    New "plain" partitions shall be [created slightly differently](https://github.com/Olf0/crypto-sdcard/commit/ba3ccce0c3573747fadd7b30e576159b15277513#commitcomment-47340935) now, in order to take advantage of this enhancement.
